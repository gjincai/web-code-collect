;(function ($) {
  ...
  var App = function () {
    ...
    // this.$dialog_login = $('.j_dialogLogin')
  ...
  $.extend(App.prototype, {
    ...
    getInfo: function (status) {
      ...
      // $.ajax({
      //   url: that.config['activityapi_url'] + '/anniversary/info',
      //   data: api_params,
      //   type: 'post',
      //   success: function (response) {
      //     if (response.code == 0) {
    ...
    backRole: function (data) {
      ...
      $.ajax({
        url: 'https://weekly-sszg.shiyuegame.com/api.php/pf/anniversary/back',
        data: api_params,
        type: 'get',
        success: function (response) {
    ...
    receive: function (e) {
      ...
      $.ajax({
        url: 'https://weekly-sszg.shiyuegame.com/api.php/pf/anniversary/gift',
        data: api_params,
        type: 'get',
        success: function (response) {
          var res = JSON.parse(response)
    ...
    myPop: function (e) {
      ...
      $.ajax({
        url: that.config['activityapi_url'] + '/anniversary/optInfo',
        data: api_params,
        type: 'post',
        success: function (response) {
          if (response.code == 0 && response.data.length != 0) {
